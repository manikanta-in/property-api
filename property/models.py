...
class Property(models.Model):
    ...
    extent_in = models.DecimalField(max_digits=10,decimal_places=2,blank=False, default=0)
    road_size = models.DecimalField(max_digits=10,decimal_places=2,blank=False, default=0)
    ...
    offer_price = models.DecimalField(max_digits=10,decimal_places=2,blank=False, default=0)
    near_market_value = models.DecimalField(max_digits=10,decimal_places=2,blank=False, default=0)
    distance_from_orr = models.DecimalField(max_digits=10,decimal_places=2,blank=False, default=0)
